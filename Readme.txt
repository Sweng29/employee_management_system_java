...
### Strategy
 ...
 UserDAO (interface) is designed on this pattern (UserDAOImpl is implementing this interface)
 this interface has following methods to implement 1. registerUser 2. loginUser 
3. updateUser
4. deleteUser
5. findAllUsers
6. findById
all methods have different implementation.
